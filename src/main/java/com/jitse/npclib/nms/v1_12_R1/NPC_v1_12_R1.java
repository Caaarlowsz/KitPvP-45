package com.jitse.npclib.nms.v1_12_R1;
...
import com.jitse.npclib.nms.v1_12_R1.packets.*;
...
public class NPC_v1_12_R1 extends NPCBase {
    ...
    public void sendShowPackets(Player player) {
        ...
        this.hologram = new Hologram(MinecraftVersion.V1_12_R1, location.clone().add(0, 0.5, 0), newText);
    ...
    public void sendEquipmentPacket(Player player, NPCSlot slot, boolean auto) {
        ...
        PacketPlayOutEntityEquipment packet = new PacketPlayOutEntityEquipment(entityId, EnumItemSlot.valueOf(slot.getNmsName()), CraftItemStack.asNMSCopy(item));
        playerConnection.sendPacket(packet);
    }
